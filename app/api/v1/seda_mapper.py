...
@router.get("/profile-payload/{mykad}")
async def get_profile_payload(mykad: str):
    """
    Returns the individual profile payload constructed from the mapper's database using the MyKad.
    """
    clean_mykad = mykad.replace("-", "").strip()
