...
def debug_update():
    ...
    update_data['name'] = "GAN ZHI HONG VERIFIED"
    ...
    # 4. Attempt Update
    logger.info(f"Attempting to update name to 'TEST PROFILE TEST TWO'...")
    ...
    if new_id:
        ...
        if updated_profiles and updated_profiles[0]['name'] == "TEST PROFILE TEST TWO":
